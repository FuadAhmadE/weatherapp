...
import com.weatherappv2.app.Common.Common;
import com.weatherappv2.app.Model.WeatherResult;
import com.weatherappv2.app.Retrofit.IOpenWeatherMap;
import com.weatherappv2.app.Retrofit.RetrofitClient;
    ...
    private class LoadCities extends SimpleAsyncTask<List<String>> {
        ...
        protected List<String> doInBackgroundSimple() {
            ...
            try {
                ...
                InputStream is = getResources().openRawResource(R.raw.indonesia);
        ...
        compositeDisposable.add(mService.getWeatherByCityName(cityName,
                ...
                .subscribe(new Consumer<WeatherResult>() {
                    ...
                    public void accept(WeatherResult weatherResult) throws Exception {
                        ...
                        txt_humadity.setText(new StringBuilder(
